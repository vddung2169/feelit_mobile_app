...
struct PollCardItem {
    ...
    let trending: Bool
    let currentPrice: String    // "$62,757"
...
enum PollFeedData {
    ...
    static let items: [PollCardItem] = [
        PollCardItem(id: "btc", category: "Crypto", cadence: "Hàng giờ",
                     ...
                     currentPrice: "$62,757", changePercent: "11%", isUp: true,
        ...
        PollCardItem(id: "vnindex", category: "Chứng khoán VN", cadence: "Hàng ngày",
                     ...
                     currentPrice: "1.287", changePercent: "0.8%", isUp: true,
        ...
        PollCardItem(id: "eth", category: "Crypto", cadence: "Hàng giờ",
                     ...
                     currentPrice: "$3,412", changePercent: "3.2%", isUp: false,
        ...
        PollCardItem(id: "gold", category: "Ngoại hối", cadence: "Hàng ngày",
                     ...
                     currentPrice: "88.2tr", changePercent: "1.4%", isUp: true,
        ...
        PollCardItem(id: "usd", category: "Ngoại hối", cadence: "Hàng ngày",
                     ...
                     currentPrice: "25.420", changePercent: "0.3%", isUp: false,
